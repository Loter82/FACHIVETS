...
SaaS-надбудова над існуючими інсталяціями **Unipro ERP** (оптові/роздрібні магазини будматеріалів).
CRM + сегментація + маркетинг-автоматизація + аналітика. **Жодного запису в БД Unipro** — лише читання або JSON-синхронізація.

> «UniBoost» — це наш продукт. «Unipro» у тексті — стороння POS/ERP-система клієнта, з якою інтегруємось.
...
- **Backend:** NestJS · TypeScript · Prisma · PostgreSQL · JWT (+ refresh) · BullMQ
